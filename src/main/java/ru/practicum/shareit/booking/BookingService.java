...
public interface BookingService {
    ...
    List<BookingDto> findAllByState(BookingState state, Long userId, Long from, Long size);

    List<BookingDto> findAllByOwner(BookingState state, Long userId, Long from, Long size);
